 ...
 * <li>{@link #getPluginConditionResult(android.content.Context, android.os.Bundle,android.content.Intent)} is called to
...
public abstract class AbstractPluginConditionReceiver extends AbstractAsyncReceiver {
    ...
    public final void onReceive(final Context context, final Intent intent) {
        ...
        if (isAsync() && AndroidSdkVersion.isAtLeastSdk(Build.VERSION_CODES.HONEYCOMB)) {
            final AsyncCallback callback = new AsyncCallback() {
                ...
                @Override
                public int runAsync() {
                    final int pluginResult = getPluginConditionResult(mContext, mBundle,intent);
            ...
            final int pluginState = getPluginConditionResult(context, bundle,intent);
     ...
     * {@link #getPluginConditionResult(Context, Bundle,Intent)} method performs any
