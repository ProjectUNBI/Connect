...
public class TaskerPlugin {
    ...
    /**
     * 	Action that the TaskEditActivity for an event plugin should be launched by
     */
     ...
     *
     * Used in TaskEditActivity, before setResult().
     *
    ...
    /**
     * Used by: plugin TaskEditActivity
     *
    ...
    public static class Host {
         ...
         * intents to any TaskEditActivity, FireReceiver or QueryReceiver.
         *
